...
const main = async () => {
	try {
		...
		const archaicFewshotPrompt = fs.readFileSync(path.join(__dirname, '../flows/prompts/archaic_fewshot.txt'), 'utf8');
		const poeticFewshotPrompt = fs.readFileSync(path.join(__dirname, '../flows/prompts/poetic_fewshot.txt'), 'utf8');
